        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    thread1 = new SenderThread(socket, name);
...
//        message_text_test.setTextColor(Color.parseColor("#ffffff"));
        ...
        send_button_test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                chatData = new ChattingData(R.drawable.ic_launcher_background, name, sumStr);
...
//                    sumStr = sumStr + "\n" + str;
                    System.out.println(str);
                    chatData = new ChattingData(R.drawable.ic_launcher_background, "이클립스", str);
                    arrayList.add(chatData);
                    chattingAdapter.notifyDataSetChanged();
